// File: E:\quintos_ai\app\(marketing)\careers\error.tsx
...
export default function CareersError({
  ...
  return (
    <div className="py-24 max-w-xl mx-auto px-4 text-center space-y-5">
      ...
      <h1 className="text-xl font-bold text-slate-900">Opportunities Unavailable</h1>
      <p className="text-xs text-slate-600">
        We encountered an error loading open research and engineering positions.
      </p>
