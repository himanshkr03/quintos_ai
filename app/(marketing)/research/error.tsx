// File: E:\quintos_ai\app\(marketing)\research\error.tsx
...
export default function ResearchError({
  ...
  return (
    <div className="py-24 max-w-xl mx-auto px-4 text-center space-y-5">
      ...
      <h1 className="text-xl font-bold text-slate-900">Research Trajectories Unavailable</h1>
      <p className="text-xs text-slate-600">
        An error occurred while loading foundational research papers and benchmarks.
      </p>
