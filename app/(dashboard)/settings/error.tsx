// File: E:\quintos_ai\app\(dashboard)\settings\error.tsx
...
export default function SettingsError({
  ...
  return (
    <div className="rounded-2xl border border-red-200 bg-red-50/50 p-8 text-center space-y-4 max-w-xl mx-auto my-8">
      ...
      <h2 className="text-lg font-bold text-slate-900">Failed to Load Settings</h2>
      <p className="text-xs text-slate-600 max-w-md mx-auto">
        An error occurred retrieving your workspace routing and alert settings.
      </p>
      <div className="pt-2">
        <Button
          type="button"
